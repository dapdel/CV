    ...
    <section id="section5" className="section sectionPortfolio rel">
        ...
        <div className=" flex-v">
                    ...
                    <div className="flex-h flexend larg100">
                        <div className="flex-v larg100">
                            ...
                            <div className="ligne3 flex-h flexend">
                                ...
                                <div id="projet2" className="bord larg2 haut1 coul0" onClick={() => montrerPopup(2)}><img src={`images/projets/${projets[2].main_img}`} alt="" /></div>
                            </div>
                        </div>
            ...
            <div className="ligne4 flex-h flexend">
                ...
                <div id="projet3" className="bord larg2 haut1 coul0" onClick={() => montrerPopup(3)}><img src={`images/projets/${projets[3].main_img}`} alt="" /></div>
                <div className="bord  coul0 haut1 inv4 fg"></div> 
                <div className="bord coul0 haut1 inv4 fg"></div>
                <div id="projet4" className="bord larg2 haut1 coul0" onClick={() => montrerPopup(4)}><img src={`images/projets/${projets[4].main_img}`} alt="" /></div> 
            </div>
            <div className="ligne5 flex-h haut1 flexend">
                ...
                <div id="projet5" className="bord larg2 coul0" onClick={() => montrerPopup(5)}><img src={`images/projets/${projets[5].main_img}`} alt="" /></div>
